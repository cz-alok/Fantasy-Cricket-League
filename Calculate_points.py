#Calculating points of the Players in this Python File(.py)

import sqlite3

#Connecting To CricketFantasyLeague.db

mycric = sqlite3.connect("CricketFantasyLeague.db")
curs_cric = mycric.cursor()
curs_cric.execute("SELECT * FROM match")
row = curs_cric.fetchall()
